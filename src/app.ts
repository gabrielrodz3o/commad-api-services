...
export async function buildApp() {
  ...
  healthRoutes(app); askRoutes(app); insightsRoutes(app); agentRoutes(app); actionRoutes(app); voiceRoutes(app); usageRoutes(app); watchdogRoutes(app); knowledgeRoutes(app); pushRoutes(app); telegramRoutes(app); notificationRoutes(app); mobileRoutes(app)
