...
import { catalogRoutes, catalogImportRoutes } from './routes/catalog.js'
...
export async function buildApp() {
  ...
  healthRoutes(app); askRoutes(app); insightsRoutes(app); agentRoutes(app); actionRoutes(app); voiceRoutes(app); visionRoutes(app); catalogRoutes(app); catalogImportRoutes(app); hrRoutes(app); usageRoutes(app); watchdogRoutes(app); knowledgeRoutes(app); pushRoutes(app); telegramRoutes(app); notificationRoutes(app); authRoutes(app); mobileRoutes(app)
