...
const DOMAIN_PROMPTS: Record<string, { label: string; role: string }> = {
  ...
  vacations: { label: 'Vacaciones y Pasivo Vacacional', role: 'Actúas como consultor de RRHH dominicano. Te dan saldos de vacaciones por empleado (días ganados/tomados/saldo y pasivo estimado en RD$) y solicitudes. Señala: pasivo vacacional acumulado (provisión contable), empleados con saldos altos sin disfrutar (riesgo legal Art. 177 CT y burnout), solapes de equipo y equidad entre departamentos. Montos en RD$.' },
